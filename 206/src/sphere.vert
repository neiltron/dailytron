...
void main () {
  ...
  pos = rotateX(45.0 * DEG_TO_RAD) * pos;
  ...
  // pos.x -= (u_row - 5) * 300.0;
  pos.z -= u_column - 500.0;
  // pos.y += sin(time) * 100.0;
  ...
  // pos.y += mod(time, 340.0) * 10.0;

  pos /= 100.0;

  gl_Position = projection * view * vec4(pos.zxy, 1);
}
