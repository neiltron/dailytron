...
const sphereBuffer = regl.framebuffer({
  depthStencil: false,
  colorType: 'float'
});
...
let render = function ({ tick }) {
  ...
  sphereBuffer.resize(1, 1);
  sphereBuffer.resize(dimensions.width, dimensions.height);
