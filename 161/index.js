...
for (let column = 0; column < 2; column++) {
  for (let row = 0; row < 2; row++) {
    console.log(row)
    const referenceTriangle = row === 0 ? initialTriangle.map(val => {
      return [val[0] + column * 12, val[1]]
    }) : lastTriangle;

    const newTriangle = [
      [referenceTriangle[0][0],  referenceTriangle[1][1]],
      [referenceTriangle[1][0],  referenceTriangle[2][1]],
      [referenceTriangle[0][0],  referenceTriangle[3][1]],
      [referenceTriangle[1][0],  referenceTriangle[4][1]],
      [referenceTriangle[0][0],  referenceTriangle[5][1]],
      [referenceTriangle[1][0],  referenceTriangle[5][1] + 4],
    ];
