...
function moveTo (x, y, offset) {
  if (offset > 0) {
    ...
    // if (distance < threshold) {
      ...
      x += distanceX * offset * .1;
      y += distanceY * offset * .1;
    // }
  }
...
function bezierCurveTo (x, y, x0, y0, x1, y1, offset) {
  if (offset > 0) {
    ...
    x0 += distanceX * offset * .1;
    y0 += distanceY * offset * .1;

    x1 += distanceX * offset * .1;
    y1 += distanceY * offset * .1;
  }
...
function render () {
  ...
  drawChar('M565 598l-154 -169v-429h-282v1456h282v-667l132 178l354 489h344l-490 -644l508 -812h-334z', { x: 0, y: top }, 5)
  drawChar('M565 598l-154 -169v-429h-282v1456h282v-667l132 178l354 489h344l-490 -644l508 -812h-334z', { x: 0, y: top }, 6)
  ...
  drawChar('M432 227h682v-227h-964v1456h282v-1229z', { x: letterWidth, y: top }, 5)
  drawChar('M432 227h682v-227h-964v1456h282v-1229z', { x: letterWidth, y: top }, 6)
  ...
  drawChar('M476 1456l138 -547l157 547h349v-1456h-258v431l12 681l-191 -632h-139l-171 605l12 -654v-431h-258v1456h349z', { x: letterWidth * 2, y: top }, 5)
  drawChar('M476 1456l138 -547l157 547h349v-1456h-258v431l12 681l-191 -632h-139l-171 605l12 -654v-431h-258v1456h349z', { x: letterWidth * 2, y: top }, 6)
  ...
  drawChar('M1091 0h-280l-405 939v-939h-283v1456h283l402 -935l1 935h282v-1456z', { x: letterWidth * 3, y: top }, 5)
  drawChar('M1091 0h-280l-405 939v-939h-283v1456h283l402 -935l1 935h282v-1456z', { x: letterWidth * 3, y: top }, 6)
  ...
  drawChar('M1147 621q0 -140 -37 -258t-107 -203t-170.5 -132.5t-226.5 -47.5t-224 47.5t-165 133t-102 203t-35 257.5v212q0 140 35 258t102 203.5t164.5 133.5t223.5 48q127 0 227.5 -48t170.5 -133.5t107 -203.5t37 -258v-212zM862 835q0 89 -14.5 164t-45.5 129t-79.5 84.5t-117.5 30.5q-68 0 -114 -30.5t-74 -84.5t-40 -129t-12 -164v-214q0 -88 12 -163t40 -130t74 -86t115 -31q68 0 116.5 31t79 85.5t45.5 129.5t15 164v214z', { x: letterWidth * 4, y: top }, 5)
  drawChar('M1147 621q0 -140 -37 -258t-107 -203t-170.5 -132.5t-226.5 -47.5t-224 47.5t-165 133t-102 203t-35 257.5v212q0 140 35 258t102 203.5t164.5 133.5t223.5 48q127 0 227.5 -48t170.5 -133.5t107 -203.5t37 -258v-212zM862 835q0 89 -14.5 164t-45.5 129t-79.5 84.5t-117.5 30.5q-68 0 -114 -30.5t-74 -84.5t-40 -129t-12 -164v-214q0 -88 12 -163t40 -130t74 -86t115 -31q68 0 116.5 31t79 85.5t45.5 129.5t15 164v214z', { x: letterWidth * 4, y: top }, 6)
  ...
  drawChar('M430 534v-534h-281v1456h498q119 0 215 -34.5t163.5 -96t104 -147.5t36.5 -191q0 -98 -36.5 -181t-104 -143.5t-163.5 -94.5t-215 -34h-217zM430 762h217q60 0 104 18t73.5 49t44 71.5t14.5 84.5q0 51 -14.5 95t-44 77t-73.5 52t-104 19h-217v-466z', { x: letterWidth * 5, y: top }, 5)
  drawChar('M430 534v-534h-281v1456h498q119 0 215 -34.5t163.5 -96t104 -147.5t36.5 -191q0 -98 -36.5 -181t-104 -143.5t-163.5 -94.5t-215 -34h-217zM430 762h217q60 0 104 18t73.5 49t44 71.5t14.5 84.5q0 51 -14.5 95t-44 77t-73.5 52t-104 19h-217v-466z', { x: letterWidth * 5, y: top }, 6)
